...
docker compose -f /workspace/project/docker-compose.dev.yml --project-directory /workspace/project exec app sh -lc \
  'cd /app && node agents/skills/sidebar-route-smoke/scripts/sidebar-route-smoke.js --scenario sidebar-root'
```
...
1. Run the default scenario after shared sidebar, route migration, or map-control
   changes.
