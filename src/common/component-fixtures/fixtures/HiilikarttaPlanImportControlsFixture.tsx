...
import PlanImportActionsRow from 'applets/carbon/pages/plans/plan/_components/PlanImportActionsRow'
import PlanImportCodeRecordSelect from 'applets/carbon/pages/plans/plan/_components/PlanImportCodeRecordSelect'
...
export const hiilikarttaPlanImportControlsFixture: ComponentFixture = {
  ...
  sourceGlobs: [
    'src/applets/carbon/pages/plans/plan/_components/PlanImportActionsRow.tsx',
    'src/applets/carbon/pages/plans/plan/_components/PlanImportCodeRecordSelect.tsx',
