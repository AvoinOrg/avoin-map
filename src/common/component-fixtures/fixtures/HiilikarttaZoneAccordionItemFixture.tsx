...
import ZoneAccordionItem from 'applets/carbon/pages/plans/plan/areas/_components/ZoneAccordionItem'
import { buildZoningCodeSelectOptions } from 'applets/carbon/pages/plans/plan/areas/_components/zoneAreaUtils'
...
export const hiilikarttaZoneAccordionItemFixture: ComponentFixture = {
  ...
  sourceGlobs: [
    'src/applets/carbon/pages/plans/plan/areas/_components/ZoneAccordionItem.tsx',
