...
const Terrain = ({ styleProps, className, style, ...props }: IconProps) => (
  <svg
    width={24}
    height={24}
    viewBox="0 0 24 24"
  ...
  >
    <rect
      ...
      strokeWidth="2"
    />
    <path d="M11 5C11 8 8.5 11 5 11" stroke="currentColor" strokeWidth="2" />
    <path d="M8 5C8 6.5 6.75 8 5 8" stroke="currentColor" strokeWidth="2" />
    <mask
